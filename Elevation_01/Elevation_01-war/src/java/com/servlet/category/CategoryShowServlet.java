...
//        
        ...
        List<Product> list=productFacade.FindProduct_ByCategoryId(category_id);
        request.getSession().setAttribute("products", list);
        if(request.getAttribute("products.productName") ==null)
        {
            
        }
//        
//        int product_id=Integer.valueOf(request.getParameter("category_id"));
