    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if("contact".equals(action))
            {
                ...
                contact.setContactTitle(request.getParameter("title"));
                contact.setContactFullname(request.getParameter("fullname"));
                contact.setContactEmail(request.getParameter("email"));
                contact.setContactConten(request.getParameter("comments"));
                contact.setContactDate(Date.from(Instant.EPOCH));
                contactUsFacade.create(contact);
                url="index.jsp?page=contact-us";
